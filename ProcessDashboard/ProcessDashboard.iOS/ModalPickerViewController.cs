...
namespace SharpMobileCode.ModalPicker
{
	...
	public class ModalPickerViewController : UIViewController
	{
		...
		{
			var buttonSize = new CGSize(120, 30);
			...
			_headerLabel.Frame = new CGRect(20 + buttonSize.Width, 4, 10, 35);
			_doneButton.Frame = new CGRect(2 * buttonSize.Width - 40, 7, buttonSize.Width + 40, buttonSize.Height);
